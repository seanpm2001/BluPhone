# Start of script
# BluPhone Windows 10 Preference settings
print ("Preference\n")
print ("Headphones [unable to open]")
print ("Earphones/Earbuds [unable to open]")
...
'''
File info
File version: 1 (Friday, October 30th 2020 at 11:45 am)
